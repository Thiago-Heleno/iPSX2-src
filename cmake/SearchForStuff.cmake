...
if(NOT TARGET Freetype::Freetype)
    ipsx2_add_vendored_subdirectory("3rdparty/freetype" "3rdparty/freetype")
endif()
if(NOT TARGET Freetype::Freetype)
...
if(NOT TARGET plutosvg::plutosvg)
    ...
    ipsx2_add_vendored_subdirectory("3rdparty/plutosvg1" "3rdparty/plutosvg1")
endif()
if(NOT TARGET plutosvg::plutosvg)
    find_package(plutosvg QUIET CONFIG)
endif()
...
ipsx2_require_target("Freetype::Freetype" "provide cpp/3rdparty/freetype or a package exposing Freetype::Freetype")
ipsx2_require_target("plutosvg::plutosvg" "provide cpp/3rdparty/plutosvg1 or a package exposing plutosvg::plutosvg")
